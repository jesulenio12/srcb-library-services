																...
																<td>
																	...
																	<?php echo $books->datePublished; ?><br>
																		<div style="margin-top: -60px; padding-right: 0px;">
																			...
																			<?php echo $books->bookLibraries; ?> - <?php echo substr($books->bookAccession, 3, 255); ?><br>
																		</div>
															</tr>
													<?php 
								...
								<br><br>
                                    ...
                                    <div class="form-actions">
										<div class="row">
											...
											<div class="col-md-6">
												<button type="button" class="btncancel noprint" onclick="window.location='admin.php?action=AdminCollegeDiscardedBooks'">Cancel</button>
											</div>
										</div>
										<br>
                                    </div>
