...
<title>HED Library Periodical Book List </title>
</head>
				...
				<section class="content-header" style="background-color:transparent">
                    ...
                    <center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=CollegePeriodicalList"><button type="button" class="btn-mb" style="background: #3db166; color:white">Periodical Books</button></a> 
							<a href="admin.php?action=CollegeDiscardedBooks"><button type="button" class="btn-mb" style="color:#3db166;">Discarded Books</button></a> 
                                        ...
                                        <tbody>
											<?php 
												$books = DB:: getInstance()->query("SELECT * FROM books WHERE status='Available'");
												  foreach($books->results() as $books){ ?>
													  <?php if($books->libraryClass =='College Library' && $books->bookSection =='Periodical'){?>
														  <tr>
															  ...
															  <td><?php echo $books->bookAccession ; ?></td>
															    <td align="center" class="noprint">
																  ...
																  <form method="POST" action="admin.php?action=CollegePeriodicalBookEdit&&id=<?php echo $books->id; ?>" style="display:inline">
								...
								<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog modal-lg" role="document">
										...
										<div class="modal-body">
											<form enctype="multipart/form-data" method="post" action="CollegePeriodicalAddBook.php">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="add-input-container"> 
															...
															<input type="text" class="add-input" id="datePublished" name="datePublished" data-date-format='yyyy-mm-dd' required>
														</div>
													</div>
												</div>
										...
										<div class="modal-dialog modal-md" role="document">
											<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
												...
												<div class="modal-body" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
													...
													<form enctype="multipart/form-data" method="post" action="CollegePeriodicalBulkUpload.php">
