<?php
    ...
    $sql2 = "SELECT progtrack, count(*) AS totalTrack
            FROM userlogin
            WHERE archive = 0 && libraryClass = 'High School Library' && departmentType = 'Senior High School Department' && userType = 'Student'
            GROUP BY progtrack ORDER BY totalTrack DESC";
    ...
    while($row2 = mysqli_fetch_array($result2))
    {
        ...
        $test2[$count2]["y"] = $row2["totalTrack"];
        $count2 = $count2 + 1;
    }

    // TOTAL TEACHER
    $sql3 = "SELECT departmentType, count(*) AS totalTeacher
            FROM userlogin
            WHERE archive = 0 && libraryClass = 'High School Library' && departmentType = 'Senior High School Department' OR departmentType = 'Junior High School Department' && userType = 'Teacher'
            GROUP BY departmentType ORDER BY totalTeacher DESC";
    ...
    {
        $test3[$count3]["label"] = $row3["departmentType"];
    ...
    $sql4 = "SELECT yearLevel, count(*) AS totalSyearLevel
            FROM userlogin
            WHERE archive = 0 && libraryClass = 'High School Library' && departmentType = 'Junior High School Department' && userType = 'Student'
...
<title>QRBASEDLMS - High School Library Most Borrowed Books</title>
<script>
    ...
    var chart = new CanvasJS.Chart("chartContainer2", {
        animationEnabled: true,
        title:{
            text: "TOTAL STUDENTS BY TRACKS IN SHS"
        },
...
<!-- <style>
    ...
    @media print {
        ...
        body, header, nav, aside, footer {
        display: none;
        }

        /* Display the charts with adjusted size for printing */
                        ...
                        <div class="col-xs-12" style="padding: 0px 30px 10px 30px">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
                                <div class="col-md-3"></div>
                                    ...
                                    <div class="conpost">
                                        <div class="container">
                                            <a href="admin.php?action=HighSchoolBookList">
                                                <div class="data">
                                                    <div class="content">
                                                        <?php 
                                                        $books = DB:: getInstance()->query("SELECT * FROM books WHERE discarded='0' && lost='0' && bookSection != 'Periodical' && libraryClass = 'High School Library'");
                                            ...
                                            <a href="admin.php?action=HS-OnlineBookRequested">
                                                <div class="data">
                                                    <div class="content">
                                                        <?php 
                                                        $books = DB:: getInstance()->query("SELECT * FROM books WHERE requested = 1 && status = 'Not Available' && discarded='0' && libraryClass = 'High School Library'");
                                                        $countBooks =DB:: getInstance()->count($books);?>
                                                            <div class="inner">
                                                                <h3 style="font-size:30px; font-weight:bolder">
                                                                    <?php echo $countBooks; ?>
                                            ...
                                            <a href="admin.php?action=HS-OnlineBookBorrowed">
                                                <div class="data">
                                                    <div class="content">
                                                        <?php 
                                            ...
                                            <a href="admin.php?action=hsStaff_BookLoaning">
                                                <div class="data">
                                                    <div class="content">
                                                        <?php 
                                            ...
                                            <a href="admin.php?action=HighSchoolBookList">
                                                <div class="data">
                                                    <div class="content">
                                                        <?php 
                                                        $booksAvailable = DB:: getInstance()->query("SELECT * FROM books WHERE is_borrowed='0' && status='Available' && discarded='0' && lost='0' && libraryClass = 'High School Library'");
                                    ...
                                    <div class="bookinfo">
                                        <div class="totalcal" style="border-left: 20px solid #3db166">
                                            <a href="admin.php?action=HighSchoolPeriodicalList">
                                                <?php 
                                                $booksAvailable = DB:: getInstance()->query("SELECT * FROM books WHERE bookSection = 'Periodical' && libraryClass = 'High School Library'");
                                                $countBookA =DB:: getInstance()->count($booksAvailable);?>
                                                <div class="inner">
                                        ...
                                        <div class="totalcal" style="border-left: 20px solid #3db166">
                                            <a href="admin.php?action=HighSchoolDiscardedBooks">
                                                <?php 
                                                $booksAvailable = DB:: getInstance()->query("SELECT * FROM `books` WHERE discarded = '1' && libraryClass = 'High School Library' && bookSection != 'Periodical'");
                                                $countBookA =DB:: getInstance()->count($booksAvailable);?>
                                                <div class="inner">
                                                    <h3 style="font-size:50px; font-weight:bolder; padding-left:40px; color:#163269; text-transform:uppercase; font-weight:bold">
                                                        <?php echo $countBookA; ?>
                                        ...
                                        <div class="totalcal" style="border-left: 20px solid #3db166">
                                            <a href="admin.php?action=HighSchoolBookList">
                                                <?php 
                                                $booksAvailable = DB:: getInstance()->query("SELECT * FROM books WHERE lost='1' && libraryClass = 'High School Library'");
                                                $countBookA =DB:: getInstance()->count($booksAvailable);?>
                                                <div class="inner">
                                                    <h3 style="font-size:50px; font-weight:bolder; padding-left:40px; color:#163269; text-transform:uppercase; font-weight:bold">
                                                        <?php echo $countBookA; ?>
