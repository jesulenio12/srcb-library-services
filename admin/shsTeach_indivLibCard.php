...
<title>SHS Teacher's Library Card</title>
</head>
                            ...
                            <div class="box-body">
                                    <div class="form-actions">
										<div class="row" class="noprint" style="padding:0px 150px 0px 150px">
											...
											<div class="col-md-6">
												<button type="button" class="btncancel noprint" onclick="window.location='admin.php?action=teachersShsList'">Cancel</button>
											</div>
										</div>
										<br>
                                    </div>
