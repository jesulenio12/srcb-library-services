<?php
	...
	if(ISSET($_POST['search'])){
		...
		$query=mysqli_query($conn, "SELECT * FROM `booktransactions` WHERE transactionType = 'return' &&  remarks = 'Overdue' && transactionPlace = 'Hs-Lib' && userType LIKE '$userType%' AND gender LIKE '$gender%' AND yearLevel LIKE '$yearLevel%' AND progtrack LIKE '$progtrack%' AND bookSection LIKE '$bookSection%'") or die(mysqli_error());
