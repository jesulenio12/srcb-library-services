...
<title>QRBASEDLMS - Book Issued </title>
</head>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Book Issued</li>
                    </ol>
					<br>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                ...
                                <table class="table table-bordered table-hover" id="articles">
                                        ...
                                        <tbody>
											<?php
												$books = DB:: getInstance()->query("SELECT * FROM books WHERE approved ='1' && received = '0'");
                                                if($books->results() > 0){
												foreach($books->results() as $books){ 
                                                    if($books->library_userID == $user->data()->username){
                                                    ?>
														<tr>
                                                            <td><?php echo $books->libraryClass ; ?></td>
															...
															<td><?php echo $books->returnDay ; ?></td>
                                                            <td align="center">
																...
																<form method="POST" action="" style="display:inline">
																	...
																	<button class="btn btn-xs btn-success" type="button" data-toggle="modal" data-target="#confirmReceived" data-title="Received Confirmation" data-message="Are you sure you want to approve this?">
																		<i class="glyphicon glyphicon-ok"></i> Confirm
																	</button>
																</form>
															</td>
														</tr>
                                                            <div class="modal fade" id="confirmReceived" tabindex="-1" role="dialog" aria-labelledby="confirmReceivedLabel" aria-hidden="true">
																<div class="modal-dialog modal-lg" role="document">
																	<div class="modal-content">
																		<div class="modal-header">
																			<center>
																				<h4 class="modal-title">Receive Confirmation</h4>
																			</center>
																		</div>
																	<div class="modal-body">
																	<center>
																		Are you sure you received the book?
																	</center>
																</div>
																<div class="modal-footer">
																	<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
																	<button type="button" class="btn btn-primary" id="confirm" >Received</button>
																</div>
															</div>
												    <?php 	
													}
