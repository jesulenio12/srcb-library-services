								...
								<br>
									<center>
										...
										<div class="under-label-btn">
											<a style="color: #fff;" href="admin.php?action=hedTeach_allLibCard"><button type="button" style="background: #fff; color: #3db166;" class="abtnb">BULK PRINTING </button></a>
											<a style="color: #fff;" href="admin.php?action=hedTeach_allLibCardSelect"><button type="button" style="background: #3db166; color:white" class="abtnr">SELECTIVE PRINTING</button></a> 
										</div>
									</center>
                            	<div class="box-body">
									<br>
									...
									<div class="libcard">
										<?php include 'hedTeach_allLibCardFilterSelect.php'?>
									</div>
								<!-- Modal -->
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
