    ...
    if(Token::check(Input::get('token'))) {
		$userlogin = new UserLogin();
			try {
				...
				Redirect::to('admin.php?action=libuserList');
			} catch(Exception $e) {
				$error;
			}
    }
...
<title>QRBASEDLMS - User Information</title>
</head>
                            ...
                            <div class="box-body">
								...
								<form id="editUser" action="" method="post">
										...
										<div class="col-lg-3 col-md-3">
                                            ...
                                            <div class="form-group">
												<select class="form-control" name="role" id="role">
													...
													<?php
														$userRole = DB:: getInstance()->query("SELECT * FROM groups WHERE name = 'Student' OR name = 'Teacher'");							
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="button" class="btn btn" onclick="window.location='admin.php?action=hedStud_OnlineUserList'">Cancel</button>
                                    </div>
                                    <br />
                                </form>         
								<?php }?>                 
