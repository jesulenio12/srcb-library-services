...
if (Input::exists()) {
    $PNG_TEMP_DIR = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'hsBookQRCodes' . DIRECTORY_SEPARATOR;
    ...
    if ($books->count()) {
        ...
        if (!empty($bookTitle)) {
             Redirect::to('admin.php?action=hsBookViewCopies&bookTitle=' . urlencode($_GET['bookTitle']));
        } else {
           Redirect::to('admin.php?action=HighSchoolBookList');
        }
    }
                            ...
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover" id="books">
                                        ...
                                        <tbody>
											<?php include 'hsBookViewCopiesFilter.php'?>	
                                        </tbody>
                                    </table>
                                    <a style="color: #fff;" href="admin.php?action=HighSchoolBookList">
