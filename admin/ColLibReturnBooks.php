                                ...
                                <div class="box-body">
									<div class="row">
										...
										<form enctype="multipart/form-data" method="post" action="" >
											...
											<div class="col-xs-7" style="text-transform:uppercase; margin-top: -55px;">
													<br><br>
													...
													<div class="row">
														<div class=" col-md-6">
															<div style="width:92%; height:50px; background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; padding: 5px 0px 0px 15px; font-size: 25px; color:white; position: absolute; border-radius:10px; text-align:center; border: 3px solid white"> 
													...
													<div class="row">
														<div class="col-md-6">
															<div class="input-container"> 
																<span for="bookSection">Section</span>
													...
													<div class="row">
														<div class="col-md-6">
															<div class="input-container"> 
																<span for="datePublished">© Year</span>
													...
													<div class="row">
														...
														<div class=" col-md-6">
															<a style="color: #fff;" href="admin.php?action=hedStaff_BookLoaning"><button type="button" class="btnc">CANCEL</button></a> 
														</div>
													</div>
												</div>
											</div>
