...
if (Input::exists()) {
			...
			Redirect::to('admin.php?action=reviewersListBook');
            } catch(Exception $e) {
                $error;
            }
}
								...
								<form id="editUser" action="" method="post">
									<div class="row">
										<div class="col-lg-6 col-md-6">
											<label class="control-label" for="bookAccession"><font color="#EC0003">*</font> Book Accession </label>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="button" class="btn btn" onclick="window.location='admin.php?action=reviewersListBook'">Cancel</button>
                                    </div>
                                    <br />
                                </form>
								<!-- Modal -->
													...
													<div class="modal-dialog modal-lg" role="document">
														...
														<div class="modal-body">
															<form enctype="multipart/form-data" method="post" action="reviewers_editBookQR.php">
