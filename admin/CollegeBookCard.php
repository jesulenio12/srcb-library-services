								...
								<br><br>
                                    ...
                                    <div class="form-actions">
										<div class="row">
											...
											<div class="col-md-6">
												<a class="noprint" style="color: #fff;" href="admin.php?action=hedBookViewCopies&bookTitle=<?php echo urlencode($_GET['bookTitle']); ?>">
													<button type="button" class="btncancel noprint">CANCEL</button>
												</a>
											</div>
										</div>
										<br>
