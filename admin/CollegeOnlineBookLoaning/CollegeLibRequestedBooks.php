...
if (Input::exists()) {
		...
		if ($books->count()){
			...
			Redirect::to('admin.php?action=CollegeLibRequestedBooks');
}
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
                                ...
                                <div class="table-responsive">
									...
									<table class="table table-bordered table-hover" id="articles">
                                        ...
                                        <tbody>
											<?php
												$books = DB:: getInstance()->query("SELECT * FROM books WHERE requested = '1'");
                                                if($books->results() > 0){
												foreach($books->results() as $books){ 
													if($books->library_userID == $user->data()->username){
														?> 
															<tr>
																...
																<td data-label="Date Requested"><?php echo $books->dateRequested ; ?></td>
																<td align="center" data-label="Status">
																	<!-- Updated code Sept-18-22-->
																	<?php if($books->approved == 0){?>
																...
																<td align="center">
																	...
																	<form method="POST" action="" style="display:inline">
																		...
																		<button class="btncanreq" type="button" data-toggle="modal" data-target="#confirmRemove" data-title="Confirm Cancelation" data-message="Are you sure you want to cancel this?">
