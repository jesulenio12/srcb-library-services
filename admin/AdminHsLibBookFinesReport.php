...
<title>HS Book Fines Report</title>
</head>
<style>
	.size-a-19 {
		width: 100%;
                  ...
                  <br>
                    <center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=AdminHsLibBookFinesReport"><button type="button" class="btn" style="background: #3db166; color:white">HS LIBRARY</button></a>
								...
								<div class="col-md-3"></div>
									...
									<div class="box-body table-responsive">	
										...
										<table class="table table-bordered" id="articles">
											...
											<tbody>
												<?php include 'AdminGsLibBookFinesReportFilter.php'?>	
											</tbody>
										</table>
									</div>	
                            </div><!-- /.box -->
