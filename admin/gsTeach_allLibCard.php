...
<title>GS Teacher's Library Cards</title>
</head>
									...
									<center class="noprint">
                                        <div class="small-box bg" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 25px 0px 0px 0px; width:95%; font-family: Wide Latin; height: 130px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
                                            <p style="font-size:35px; transform: scale(1, 2);">
                                                GS TEACHER LIBRARY CARDS
                                            </p>
                                            <a style="color: #fff;" href="admin.php?action=gsTeach_allLibCard"><button type="button" class="abtnb">BULK PRINTING </button></a>
                                            <a style="color: #fff;" href="admin.php?action=gsTeach_allLibCardSelect"><button type="button" class="abtnr">SELECTIVE PRINTING</button></a> 
                                        </div>
                                    </center>
                            	<div class="box-body">
									<br>
									<div class="noprint">
										<form class="form-inline" method="POST" action="">
											<center>
                                        		...
                                        		<a style="color: #fff;" href="admin.php?action=gsTeach_allLibCard"><button class="btn2 noprint" type="button"><i class="fa fa-refresh"></i></button></a>
												<button class="btn2 noprint" name="search" onclick="window.print();"><i class="fa fa-print"></i></button>
												<button style="margin-left:3px" type="button" class="btn2-1 noprint" onclick="window.location='admin.php?action=teachersElemList'">Cancel</button>
											</center>
										</form>
										<br>
									</div>
									...
									<div class="libcard">
										<?php include 'gsTeach_allLibCardFilter.php'?>
									</div>
								<!-- Modal -->
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
