<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "SELECT fullname, count(*) AS topName
                FROM attendance
                WHERE libraryClass = 'College Library' && userType = 'Student'
                AND timeIn BETWEEN '$startDate' AND '$endDate' AND gender LIKE '$gender%' AND yearLevel LIKE '$yearLevel%' AND progtrack LIKE '$progtrack%' AND departmentType LIKE '$departmentType%'
                ...
                <section class="content-header" style="background-color:transparent">
                  <br>
                    ...
                    <ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
                        ...
                        <a href="admin.php?action=StaffHedStudLibraryUsers"><button type="button" class="btn" style="background: #3db166; color:white">Students</button></a> 
                        <a href="admin.php?action=StaffHedTeachLibraryUsers"><button type="button" class="btn" style="color: #3db166;">Teachers</button></a> 
                    </ol>
                    </center>
                </section>
                                ...
                                <div class="col-md-3"></div>
                                    ...
                                    <center>
                                        <div class="small-box bg">
                                            <p> TOP LIBRARY DAILY USERS  </p>
                                        </div>
                                        <div class="under-label-btn">
                                            <a style="color: #fff;" href="admin.php?action=StaffHedStudLibraryUsers"><button type="button" style="background: #fff; color: #3db166;" class="abtnb">TABLE DATA </button></a>
                                            <a style="color: #fff;" href="admin.php?action=StaffHedStudLibraryUsersGraph"><button type="button" style="background: #3db166; color:white" class="abtnr">GRAPHICAL DATA</button></a> 
                                        </div>
                                    </center>
                                    <center>
                                        <p class="styled-text">HED TOP LIBRARY USERS LOGGED RECORD</p>
                                    </center>
                                    <br>
                                    <div class="noprint">
                                        <form method="post" action="">
                                            ...
                                            <div class="wrap-filter">
                                                ...
                                                <a class="filtersbtn noprint" href="admin.php?action=StaffHedStudLibraryUsersGraph"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
