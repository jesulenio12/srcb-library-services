                            ...
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
                                <div class="col-md-3"></div>
                                    ...
                                    <center>
                                        ...
                                        <div class="under-label-btn">
                                            <a style="color: #fff;" href="admin.php?action=StaffHedStudTopBorrowers"><button type="button" class="abtnb">TABLE DATA </button></a>
                                            <a style="color: #fff;" href="admin.php?action=StaffHedStudTopBorrowersGraph"><button type="button" class="abtnr">GRAPHICAL DATA</button></a> 
                                        </div>
                                    </center>
                                    <center>
                                        ...
                                        <form class="form-inline" method="POST" action="">
                                            <center>
												...
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=StaffHedStudTopBorrowers"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover" id="articles">
                                        ...
                                        <tbody>
                                            <?php include 'StaffHedStudTopBorrowersFilter.php'?>
                                        </tbody>
                                    </table>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
