<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "SELECT fullname, count(*) AS topName
                ...
                WHERE userType = 'Teacher' && transactionType = 'return' && transactionPlace = 'Col-Lib'
                AND transactionDate BETWEEN '$startDate' AND '$endDate' AND gender LIKE '$gender%' AND departmentType LIKE '$departmentType%'
                                ...
                                <div class="col-md-3"></div>
                                    ...
                                    <center>
                                        ...
                                        <div class="under-label-btn">
                                            <a style="color: #fff;" href="admin.php?action=StaffHedTeachTopBorrowers"><button type="button" style="background: #fff; color: #3db166;" class="abtnb">TABLE DATA </button></a>
                                            <a style="color: #fff;" href="admin.php?action=StaffHedTeachTopBorrowersGraph"><button type="button" style="background: #3db166; color:white" class="abtnr">GRAPHICAL DATA</button></a> 
                                        </div>
                                    </center>
                                    <center>
                                    ...
                                    <div class="noprint">
                                        <form method="post" action="">
                                            <div class="wrap-filter">
                                                ...
                                                <a class="filtersbtn noprint" href="admin.php?action=StaffHedTeachTopBorrowersGraph"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
