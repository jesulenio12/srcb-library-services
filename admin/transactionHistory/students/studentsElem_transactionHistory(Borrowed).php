...
<title>GS Students Books Borrowed Report</title>
</head>
<style>
	.size-a-19 {
		width: 100%;
                                ...
                                <div class="noprint">
                                        <form class="form-inline" method="POST" action="" >
                                            <center>
												...
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=studentsElem_transactionHistory(Borrowed)"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
									...
									<div class="table-responsive">	
										<table class="table table-bordered table-hover" id="articles">
											...
											<tbody>
                                                <?php include 'admin/transactionHistory/bookloanDF/students/grdschl_bookborrowedDF.php'?>	
											</tbody>
										</table>
									</div>	
                            </div><!-- /.box -->
