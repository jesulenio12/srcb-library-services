...
<title>HED Teachers Books Borrowed Report</title>
</head>
<style>
	.size-a-19 {
		width: 100%;
                   ...
                   <br>
					<center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=teachersHed_transactionHistory(Borrowed)"><button type="button" class="btn-mb" style="background: #3db166; color:white">HED Teachers</button></a> 
										...
										<center class="noprint">
											<div class="small-box bg" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 25px 0px 0px 0px; width:95%; font-family: Wide Latin; height: 130px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
												<p style="font-size:35px; transform: scale(1, 2);">
													HED BOOKS BORROWED REPORT
												</p>
                                                <a style="color: #fff;" href="admin.php?action=teachersHed_transactionHistory(Borrowed)"><button type="button" class="abtnb">BORROWED BOOKS</button></a>
                                                <a style="color: #fff;" href="admin.php?action=teachersHed_transactionHistory(Returned)"><button type="button" class="abtnr">RETURNED BOOKS</button></a> 
											</div>
										</center>
									<br>
                                ...
                                <div class="noprint">
                                        <form class="form-inline" method="POST" action="" >
                                            <center>
                                                ...
                                                <div class="wrap-filter" class="noprint">
                                                    ...
                                                    <a class="filtersbtn" href="admin.php?action=teachersHed_transactionHistory(Borrowed)"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
									...
									<div class="table-responsive">	
                                        <table class="table table-bordered table-hover" id="articles">
											...
											<tbody>
                                                <?php include 'admin/transactionHistory/bookloanDF/teachers/hed_bookborrowedteachDF.php'?>	
											</tbody>
										</table>
									</div>	
                            </div><!-- /.box -->
