...
<title>HED Library Book Fines</title>
</head>
<style>
	.size-a-19 {
		width: 100%;
								...
								<div class="col-md-3"></div>
									...
									<form class="form-inline" method="POST" action="">
										<center>
											<div class="wrap-filter" class="noprint">
												...
												<a class="filtersbtn" href="admin.php?action=CollegeLibFines"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
											</div>
										</center>
									</form>
									<br>
									<div class="box-body table-responsive">	
										...
										<table class="table table-bordered" id="articles">
											...
											<tbody>
												<?php include 'Filter_CollegeFinesReport.php'?>	
											</tbody>
										</table>
									</div>	
                            </div><!-- /.box -->
