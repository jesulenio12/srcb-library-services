            ...
            <aside class="right-side"  style="background-color:transparent">
                ...
                <section  class="col-lg-12 connectedSortable">
                        <div class="col-xs-12" style="padding: 0px 15px 10px 15px">
                            <div class="box box-primary" class="noprint" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
								<br>
									<center>
																...
																<td>
																	...
																	<?php echo $books->datePublished; ?><br>
																		<div style="margin-top: -60px; padding-right: 0px;">
																			<p style="text-transform:uppercase; margin:0px; font-weight: bold; margin-left: 60px;">
								...
								<br><br>
                                    ...
                                    <div class="form-actions">
										<div class="row">
											...
											<div class="col-md-6">
												<button type="button" class="btncancel noprint" onclick="window.location='admin.php?action=HighSchoolDiscardedBooks'">Cancel</button>
											</div>
										</div>
										<br>
                                    </div>
