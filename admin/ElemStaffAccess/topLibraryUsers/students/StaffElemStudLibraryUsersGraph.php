<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "SELECT fullname, count(*) AS topName
                FROM attendance
                WHERE libraryClass = 'Grade School Library' && userType = 'Student' && departmentType = 'Grade School Department'
                                    ...
                                    <div class="noprint">
                                        <form method="post" action="">
                                            <div class="wrap-filter">
                                                ...
                                                <a class="filtersbtn" href="admin.php?action=StaffElemStudLibraryUsersGraph"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
