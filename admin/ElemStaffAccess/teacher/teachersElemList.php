...
<title>GS Teachers Students Walk-in Library Users List</title>
</head>
                ...
                <section class="content-header" style="background-color:transparent">
					...
					<center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=studentsElemList"><button type="button" class="btn" style="color:#3db166">Students</button></a> 
							<a href="admin.php?action=teachersElemList"><button type="button" class="btn" style="background: #3db166; color:white">Teachers</button></a> 
						</ol>
                    </center>
                </section>
										...
										<div class="conpost">
											<div class="container">
												<div class="data">
													<div class="content">
													<?php 
													$userlogin = DB:: getInstance()->query("SELECT * FROM userlogin WHERE departmentType='Grade School Department' && userType='Teacher' AND archive = 0");
												...
												<div class="data">
													<div class="content">
													<?php 
													$library_usersGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Male' AND departmentType='Grade School Department' AND userType='Teacher' AND archive = 0");
												...
												<div class="data">
													<div class="content">
													<?php 
													$library_usersGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Female' AND departmentType='Grade School Department' AND userType='Teacher' AND archive = 0");
													$countLibrary_usersG =DB:: getInstance()->count($library_usersGender);?>
														<div class="inner">
															<h3>
																<?php echo $countLibrary_usersG; ?>
										...
										<form class="form-inline" method="POST" action="">
											<center>
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=teachersElemList"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
													<button class="filtersbtn" onclick="window.print();"><i class="fa fa-print"></i></button>
													<a class="filtersbtn" href="admin.php?action=gsTeach_allLibCard"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="glyphicon glyphicon-qrcode"></i></button></a>
                                ...
                                <div class="box-body table-responsive">
									...
									<?php }?>
										<table class="table table-bordered table-hover" id="articles">
											...
											<tbody>
												<?php include 'admin/ElemStaffAccess/libusersFilter/teachers/grdschl_teachersFilter.php'?>
											</tbody>
										</table>
                                </div><!-- /.box-body -->
									...
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
											...
											<div class="modal-body">
												<form enctype="multipart/form-data" method="post" action="teachersElem_addTeach.php">
													<div class="row">
														<div class="col-md-6">
										...
										<div class="modal-dialog modal-lg" role="document">
											<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
												...
												<div class="modal-body" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
													...
													<form enctype="multipart/form-data" method="post" action="ElemTeachUpload.php">
