...
<title>HED Teacher's Library Cards</title>
</head>
								...
								<br>
									<center class="noprint">
										<div class="small-box bg">
											<p> HED TEACHER QR CODES </p>
										</div>
										<div class="under-label-btn">
											<a style="color: #fff;" href="admin.php?action=hedTeach_allLibCard"><button type="button" style="background: #3db166; color:white" class="abtnb">BULK PRINTING </button></a>
											<a style="color: #fff;" href="admin.php?action=hedTeach_allLibCardSelect"><button type="button" style="background: #fff; color: #3db166;" class="abtnr">SELECTIVE PRINTING</button></a> 
										</div>
									</center>
                            	<div class="box-body">
									<br>
									<div class="noprint">
										<form class="form-inline" method="POST" action="">
											<center>
                                        		...
                                        		<a style="color: #fff;" href="admin.php?action=hedTeach_allLibCard"><button class="btn2 noprint" type="button"><i class="fa fa-refresh"></i></button></a>
												<button class="btn2 noprint" name="search" onclick="window.print();"><i class="fa fa-print"></i></button>
												<button style="margin-left:3px" type="button" class="btn2-1 noprint" onclick="window.location='admin.php?action=teachersHedList'">Cancel</button>
											</center>
										</form>
										<br>
									</div>
									...
									<div class="libcard">
										<?php include 'hedTeach_allLibCardFilter.php'?>
									</div>
								<!-- Modal -->
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
