...
<title>GS Book Fines Report</title>
</head>
<style>
	.size-a-19 {
		width: 100%;
                  ...
                  <br>
                    <center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=AdminColLibBookFinesReport"><button type="button" class="btn" style="color: #3db166;">HED LIBRARY</button></a> 
							<a href="admin.php?action=AdminHsLibBookFinesReport"><button type="button" class="btn" style="color: #3db166;">HS LIBRARY</button></a>
							<a href="admin.php?action=AdminGsLibBookFinesReport"><button type="button" class="btn" style="background: #3db166; color:white">GS LIBRARY</button></a>  
						</ol>
                    </center>
                </section>
                <!-- Main content -->
								...
								<div class="col-md-3"></div>
									...
									<form class="form-inline" method="POST" action="">
										...
										<div class="wrap-filter" class="noprint">
												...
												<a class="filtersbtn" href="admin.php?action=AdminGsLibBookFinesReport"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
									...
									<div class="box-body table-responsive">	
										...
										<table class="table table-bordered" id="articles">
											...
											<tbody>
												<?php include 'Filter_ElementaryLibFinesReport.php'?>	
											</tbody>
										</table>
									</div>	
                            </div><!-- /.box -->
