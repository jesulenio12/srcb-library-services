...
<title>JHS Students Online Library Users List</title>
</head>
				...
				<section class="content-header" style="background-color:transparent">
                  <br>
					...
					<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
						...
						<a href="admin.php?action=hedStud_OnlineUserList"><button type="button" class="btn-mb" style="color:#3db166;">HED Students</button></a> 
						<a href="admin.php?action=shsStud_OnlineUserList"><button type="button" class="btn-mb" style="color:#3db166;">SHS Students</button></a> 
						<a href="admin.php?action=jhsStud_OnlineUserList"><button type="button" class="btn-mb" style="background: #3db166; color:white">JHS Students</button></a> 
                        ...
                        <div class="col-xs-12" style="padding: 0px 15px 10px 15px">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
										...
										<center>
											<div class="small-box bg" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 30px 0px 0px 0px; width:95%; font-family: Wide Latin; height: 115px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
												<p style="font-size:28px; transform: scale(1, 2.5);">
													JHS STUDENTS ONLINE LIBRARY USERS LIST
												</p>
											</div>
										</center>
										<br>
										<div class="conpost">
											<div class="container">
												<div class="data">
													<div class="content">
													<?php 
													$userlogin = DB:: getInstance()->query("SELECT * FROM userlogin WHERE departmentType='Junior Higher Education Department' && yearLevel != 'Graduated' && permission != 0 && permissionRole = 5");
												...
												<div class="data">
													<div class="content">
														<?php 
														$userloginGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Male' AND departmentType='Junior Higher Education Department' && yearLevel != 'Graduated' && permission != 0 && permissionRole = 5");
														$countUserloginG =DB:: getInstance()->count($userloginGender);?>
														<div class="inner">
															<h3>
																<?php echo $countUserloginG; ?>
															</h3>
															<p>
																Male
															</p>
												...
												<div class="data">
													<div class="content">
													<?php 
													$userloginGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Female' AND departmentType='Junior Higher Education Department' && yearLevel != 'Graduated' && permission != 0 && permissionRole = 5");
													$countUserloginG =DB:: getInstance()->count($userloginGender);?>
														<div class="inner">
															<h3>
																<?php echo $countUserloginG; ?>
												...
												<div class="wrap-filter" class="noprint">
													...
													<div class="filter-input-group"> 
														...
														<select class="filter-input-box" for="classSection" name="classSection" id="classSection">
															...
															<?php
																$libusers = DB:: getInstance()->query("SELECT DISTINCT classSection FROM library_users WHERE departmentType = 'Junior High School Department' AND classSection != 'N/A' ORDER BY id ASC");							
													...
													<a class="filtersbtn" href="admin.php?action=jhsStud_OnlineUserList"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
                                ...
                                <div class="box-body table-responsive">
									<?php if(Session::exists('Deactivated')){ ?>
                                             <div class="alert alert-danger">
                                                <i class="glyphicon glyphicon-ok"></i> &nbsp;<?php echo Session::flash('Deactivated'); ?>
                                             </div>
                                    <?php }?> 
									...
									<?php }?>
									<form action="jhsStud_OnlineUserList_chkboxcode.php" method="POST">
										<table class="table table-bordered table-hover" id="articles">
											<thead>
												<tr>
													...
													<th style="width:6%"  class="noprint">
														<!-- UPDATE YEAR LEVEL -->
														<center>
															<button type="button" class="btn7" data-toggle="modal" data-target="#deletemultiModal"><i class="fa fa-ban"></i></button>	
														</center>
															<!-- DELETE MULTIPLE -->
																...
																<div class="modal-dialog modal-lg" role="document">
																	<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
																		...
																		<div class="modal-body">
																			<center>
																				<p  style="font-size:30px"> Are you sure you want to deactivate? </p>
																			</center>
																			<div class="modal-footer">
																				<div class="row">
																					<div class="col-md-6">
																						<button type="submit" name="stud_delete_multiple_btn" class="btnupdate" style="color: #fff" value="Upload">Deactivate</button>
																					</div>
																					<div class="col-md-6">
											...
											<tbody>
												<?php include 'jhsStud_OnlineUserListFilter.php'?>
											</tbody>
										</table>
									</form>
                                </div><!-- /.box-body -->
										...
										<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
													<center>
														<div class="small-box" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 14px 0px 0px 0px; width:100%; font-family: Wide Latin; height: 80px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
															<p id="exampleModalLabel" style="font-size:29px; transform: scale(.7, 1); text-transform: uppercase">
																Add New Student
															</p>
														</div>
													</center>
											...
											<div class="modal-body">
												<form method="post" action="Add_jhs_OnlineUser.php">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="add-input-container"> 
																<span for="username">ID Number</span>
										...
										<div class="modal-dialog modal-lg" role="document">
											...
											<div class="modal-header">
												...
												<center>
													...
													<a style="color:#fff" href="CSVLibUsersAccountTemplate.php"> <button style="width:90%;" class="btncsv" type="submit"> Download CSV Template <i class="fas fa-file-download"></i></button></a>
												</center>
											</div>
											<br>
											<div class="modal-body" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
												<form enctype="multipart/form-data" method="post" action="LibUserBulkUpload.php">
													<div class="row">
														<div class="col-md-12">
															<div style="width:25%; height:50px; background-color:#163269; color:white; padding: 13px 8px 0px 15px; color:white; font-size: 17px;  text-align: center; position: absolute; border-radius:5px"> 
																<label class="control-label" for="datePublished">Choose File</label>
															</div>
															<div class="form-group" style="width:100%; padding-left:29px;">
																<input style="height:50px; padding-top:12px; font-size: 17px;" type="file" class="form-control" name="libusercsv_file" >
															</div>
														</div>
													</div>
											<div class="modal-footer">
