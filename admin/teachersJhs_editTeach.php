...
<title>JHS Department Teachers</title>
</head>
								...
								<form id="editUser" action="" method="post">
									...
									<div class="clearfix"></div><hr />
										<div class="row">
											...
											<div class=" col-md-6">
												<a style="color: #fff;" href="admin.php?action=teachersJhsList"><button type="button" class="btncancel">CANCEL</button></a> 
											</div>
										</div>
									<br />
                                </form>
											...
											<div class="row">
												<div class="col-md-12">
													<div style="width:25%; height:50px; background-color:#163269; padding: 13px 8px 0px 15px; color:white; font-size: 17px;  text-align: center; position: absolute; border-radius:5px"> 
														<label class="control-label" for="datePublished">ID Number</label>
													</div>
													<div class="form-group" style="width:100%; padding-left:135px;">
														<input style="width:100%; height:50px; padding-top:12px; font-size: 17px;"  type="text" class="form-control" id="newlibrary_userID" name="newlibrary_userID" value="<?php echo $userlogin->library_userID; ?>">													
														<input type="hidden" name="newID" value="<?php echo $userlogin->id; ?>">
													</div>
												</div>
											</div>
												<div class="modal-footer">
													<div class="row">
													<div class="col-md-6">
														<button type="submit" class="btnupdate" value="save"></i> Save</button>
													</div>
													<div class="col-md-6">
