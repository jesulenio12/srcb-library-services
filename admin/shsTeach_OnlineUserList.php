...
<title>SHS Teachers Online Library Users List</title>
</head>
				...
				<section class="content-header" style="background-color:transparent">
                  <br>
					...
					<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
						...
						<a href="admin.php?action=hedTeach_OnlineUserList"><button type="button" class="btn-mb" style="color:#3db166;">HED Teachers</button></a> 
						<a href="admin.php?action=shsTeach_OnlineUserList"><button type="button" class="btn-mb" style="background: #3db166; color:white">SHS Teachers</button></a> 
						<a href="admin.php?action=jhsTeach_OnlineUserList"><button type="button" class="btn-mb" style="color:#3db166;">JHS Teachers</button></a> 
						<a href="admin.php?action=gsTeach_OnlineUserList"><button type="button" class="btn-mb" style="color:#3db166;">GS Teachers</button></a> 
					</ol>
                    </center>
                </section>
                <!-- Main content -->
                        ...
                        <div class="col-xs-12" style="padding: 0px 15px 10px 15px">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
										...
										<center>
											<div class="small-box bg" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 30px 0px 0px 0px; width:95%; font-family: Wide Latin; height: 115px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
												<p style="font-size:28px; transform: scale(1, 2.5);">
													SHS TEACHERS ONLINE LIBRARY USERS LIST
												</p>
											</div>
										</center>
										<br>
										<div class="conpost">
											<div class="container">
												<div class="data">
													<div class="content">
													<?php 
													$userlogin = DB:: getInstance()->query("SELECT * FROM userlogin WHERE departmentType='Senior High School Department' && permission != 0 && permissionRole = 6");
												...
												<div class="data">
													<div class="content">
														<?php 
														$userloginGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Male' AND departmentType='Senior High School Department' && permission != 0 && permissionRole = 6");
												...
												<div class="data">
													<div class="content">
													<?php 
													$userloginGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Female' AND departmentType='Senior High School Department' && permission != 0 && permissionRole = 6");
													$countUserloginG =DB:: getInstance()->count($userloginGender);?>
														<div class="inner">
															<h3>
																<?php echo $countUserloginG; ?>
										...
										<form class="form-inline" method="POST" action="">
											<center>
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=shsTeach_OnlineUserList"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
													<button class="filtersbtn" onclick="window.print();"><i class="fa fa-print"></i></button>
													<button type="button" class="btn2-1 noprint" data-toggle="modal" data-target="#exampleModal">Add Teacher</button>	
												</div>
											</center>
										</form>
										<br>
                                ...
                                <div class="box-body table-responsive">
									...
									<?php }?>
									<form action="shsTeach_OnlineUserList_chkboxcode.php" method="POST">
										<table class="table table-bordered table-hover" id="articles">
											...
											<tbody>
												<?php include 'shsTeach_OnlineUserListFilter.php'?>
											</tbody>
										</table>
									</form>
                                </div><!-- /.box-body -->
								...
								<!-- ADD NEW MODAL -->
									...
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
											...
											<div class="modal-body">
												<form method="post" action="Add_shsTeach_OnlineUser.php">
