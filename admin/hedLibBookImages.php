...
<title>HED Library Book Images</title>
</head>
                            ...
                            <div style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding: 0px 30px 10px 30px">
								...
								<center>
									<div class="small-box bg">
										<p> HED BOOK IMAGES </p>
										<button type="button" class="add-logo-btn noprint" data-toggle="modal" data-target="#importModal"><i class="fa fa-plus"></i></button>	
									</div>
								</center>
                            	<div class="box-body">
									<br>
											...
											<div class="wrap-filter" class="noprint">
												...
												<div class="filter-input-group"> 
													...
													<select class="filter-input-box" for="bookImageAuthor" name="bookImageAuthor" id="bookImageAuthor">
														...
														<?php
															$books = DB:: getInstance()->query("SELECT DISTINCT bookImageAuthor FROM bookimages WHERE bookImageLibClass = 'College Library' ORDER BY id ASC");							
												...
												<div class="filter-input-group"> 
													...
													<select class="filter-input-box" for="bookImageSection" name="bookImageSection" id="bookImageSection">
														...
														<?php
															$books = DB:: getInstance()->query("SELECT DISTINCT bookImageSection FROM bookimages WHERE bookImageLibClass = 'College Library' ORDER BY id ASC");							
															foreach($books->results() as $books){
														?>
												...
												<a class="filtersbtn" href="admin.php?action=hedLibBookImages"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
											</div>
										</center>
									</form>
									...
									<div class="bookqr">
										<?php include 'hedLibBookImagesFilter.php'?>
									</div>
								<!-- Modal -->
										...
										<div class="modal-dialog modal-md" role="document">
											<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
												...
												<div class="modal-body" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
													<form enctype="multipart/form-data" method="post" action="hedLibAddImage.php">
														<div class="row">
															<div class="col-md-6">
