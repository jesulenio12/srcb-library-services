...
if (Input::exists()) {
    if(Token::check(Input::get('token'))) {  
			...
			Session::flash('Returned', 'New Book has been returned.');
			Redirect::to('admin.php?action=hsStaff_BookLoaning');
			} catch(Exception $e) {
				echo ($e->getMessage());
			}
    }
										...
										<form enctype="multipart/form-data" method="post" action="" >
											...
											<br><br>
													...
													<div class="row">
														...
														<div class=" col-md-6">
															<a style="color: #fff;" href="admin.php?action=hsStaff_BookLoaning"><button type="button" class="btnc">CANCEL</button></a> 
														</div>
													</div>
												</div>
											</div>
