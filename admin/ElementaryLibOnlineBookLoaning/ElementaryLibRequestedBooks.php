...
if (Input::exists()) {
		...
		if ($books->count()){
			...
			Redirect::to('admin.php?action=ElementaryLibRequestedBooks');
}
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover" id="articles">
                                        ...
                                        <tbody>
											<?php
												$books = DB:: getInstance()->query("SELECT * FROM books WHERE libraryClass = 'Elementary Library' && requested = '1'");
                                                if($books->results() > 0){
												foreach($books->results() as $books){ 
