...
<title>QRBASEDLMS - Returned Books </title>
</head>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                ...
                                <table class="table table-bordered table-hover" id="articles">
                                        ...
                                        <tbody>
											<?php
                                                    $books = DB:: getInstance()->query("SELECT * FROM booktransactions WHERE transactionType = 'return' && returned ='1'");
                                                    if($books->results() > 0){
                                                    foreach($books->results() as $books){ 
                                                        if($books->library_userID == $user->data()->username){?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo date('d/m/Y | h:i A', strtotime($books->transactionTime ));?></td>
                                                                <td align="center">
                                                                    <?php if($books->fines != 0){?>
                                                                        <span class="label label-danger"> ₱<?php echo $books->fines ; ?>.00 </span>
                                                                        <?php }else{?>
																	  <span> ₱<?php echo $books->fines ; ?>.00 </span>
																    <?php }?>
                                                                </td>
                                                                <td align="center">
                                                                    <?php if($books->returned == 1){?>
