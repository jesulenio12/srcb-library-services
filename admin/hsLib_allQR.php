...
<title>HS Library QR Codes</title>
</head>
                            	...
                            	<div class="box-body">
									...
									<form class="form-inline" method="POST" action="" style="margin-left: 20px">
										<center class="noprint" >
											...
											<a style="color: #fff;" class="noprint"  href="admin.php?action=hsLib_allQR"><button class="btn2 noprint" type="button"><i class="fa fa-refresh"></i></button></a>
											<button class="btn2 noprint" name="search" onclick="window.print();"><i class="fa fa-print"></i></button>
											<button style="margin-left:3px" type="button" class="btn2-1 noprint" onclick="window.location='admin.php?action=HighSchoolBookList'">Cancel</button>
										</center>
									</form>
									...
									<div class="bookqr">
										<?php include 'hsLib_allQRFilter.php'?>
									</div>
								<!-- Modal -->
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
