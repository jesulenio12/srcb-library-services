<?php
	require 'conn.php';
	$query=mysqli_query($conn, "SELECT * FROM `attendance` WHERE libraryClass = 'High School Library' AND MONTH(timeIn) = MONTH(CURRENT_DATE) AND YEAR(timeIn) = YEAR(CURRENT_DATE) ORDER BY `id` DESC") or die(mysqli_error());
