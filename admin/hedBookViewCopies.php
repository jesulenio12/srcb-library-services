                            ...
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
								...
								<center>
									<div class="small-box bg">
										<p class="dynamic-title" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%; font-size:30px; transform: scale(1, 2); padding: 3px;">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover" id="books">
                                        ...
                                        <tbody>
											<?php include 'hedBookViewCopiesFilter.php'?>	
                                        </tbody>
                                    </table>
                                    <a style="color: #fff;" href="admin.php?action=CollegeBookList">
