...
<title>HED STUDENTS TOP BORROWERS</title>
                                ...
                                <div class="col-md-3"></div>
                                    ...
                                    <center>
                                        ...
                                        <div class="under-label-btn">
                                            <a style="color: #fff;" href="admin.php?action=CollegeMostBorrowedBooks"><button type="button" class="abtnb">TABLE DATA </button></a>
                                            <a style="color: #fff;" href="admin.php?action=CollegeMostBorrowedBooksGraph"><button type="button" class="abtnr">GRAPHICAL DATA</button></a> 
                                        </div>
                                    </center>
                                    <center>
                                        ...
                                        <form class="form-inline" method="POST" action="">
                                            <center>
												...
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=CollegeMostBorrowedBooks"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
                                    ...
                                    <table class="table table-bordered table-hover" id="articles">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Course</th>
                                                <th>Department</th>
                                                <th style="width:7%">Times Borrowed</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php include 'CollegeMostBorrowedBooksFilter.php'?>
                                        </tbody>
                                    </table>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
