...
<title>JHS Students Walk-in Library Users List</title>
</head>
				...
				<section class="content-header" style="background-color:transparent">
                  <br>
                    ...
                    <ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
                        ...
                        <a href="admin.php?action=studentsShsList"><button type="button" class="btn" style="color:#3db166">SHS Students</button></a> 
                        <a href="admin.php?action=studentsJhsList"><button type="button" class="btn" style="background: #3db166; color:white">JHS Students</button></a> 
                    </ol>
                    </center>
                </section>
                <!-- Main content -->
                        ...
                        <div class="col-xs-12" style="padding: 0px 15px 10px 15px">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
											...
											<div class="conpost">
												<div class="container">
													<div class="data">
														<div class="content">
														<?php 
														$userlogin = DB:: getInstance()->query("SELECT * FROM userlogin WHERE departmentType='Junior High School Department' && yearLevel != 'Graduated' && userType='Student' AND archive = 0");
													...
													<div class="data">
														<div class="content">
															<?php 
															$library_usersGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Male' AND departmentType='Junior High School Department' && yearLevel != 'Graduated' AND userType='Student' AND archive = 0");
													...
													<div class="data">
														<div class="content">
														<?php 
														$library_usersGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Female' AND departmentType='Junior High School Department' && yearLevel != 'Graduated' AND userType='Student' AND archive = 0");
														$countLibrary_usersG =DB:: getInstance()->count($library_usersGender);?>
															<div class="inner">
																<h3>
																	<?php echo $countLibrary_usersG; ?>
										...
										<form class="form-inline" method="POST" action="">
											<center>
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=studentsJhsList"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
													<button class="filtersbtn" onclick="window.print();"><i class="fa fa-print"></i></button>
													<a class="filtersbtn" href="admin.php?action=jhsStud_allLibCard"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="glyphicon glyphicon-qrcode"></i></button></a>
                                ...
                                <div class="box-body table-responsive">
									...
									<?php }?>
									<!-- <form action="jhs_chkboxcode.php" method="POST"> -->
										<table class="table table-bordered table-hover" id="articles">
											...
											<tbody>
												<?php include 'admin/HighSchoolStaffAccess/libusersFilter/students/jhs_studentsFilter.php'?>
											</tbody>
										</table>
									<!-- </form> -->
                                </div><!-- /.box-body -->
									...
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
											...
											<div class="modal-body">
												<form enctype="multipart/form-data" method="post" action="studentsJhs_addStud.php">
											...
											<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
												...
												<div class="modal-body" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
													<p class="form-paragraph">
														File should be a .csv format or download this file template <a style="color:#fff" href="CSVStudentsTemplate_JHS.php"> <button class="btncsv" type="submit"> CSV Template <i class="fas fa-file-download"></i></button></a>
													</p>
													<form enctype="multipart/form-data" method="post" action="JhsStudUpload.php">
