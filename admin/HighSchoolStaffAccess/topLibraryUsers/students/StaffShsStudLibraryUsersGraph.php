<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "SELECT fullname, count(*) AS topName
                FROM attendance
                WHERE libraryClass = 'High School Library' && userType = 'Student'
                                ...
                                <div class="col-md-3"></div>
                                    ...
                                    <center class="noprint">
                                        <div class="small-box bg" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 25px 0px 0px 0px; width:95%; font-family: Wide Latin; height: 130px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
                                            ...
                                            <a style="color: #fff;" href="admin.php?action=StaffShsStudLibraryUsers"><button type="button" style="background: #fff; color: #3db166;" class="abtnb">TABLE DATA </button></a>
                                            <a style="color: #fff;" href="admin.php?action=StaffShsStudLibraryUsers"><button type="button" style="background: #3db166; color:white" class="abtnr">GRAPHICAL DATA</button></a> 
                                        </div>
                                    </center>
                                    <center>
                                    ...
                                    <div class="noprint">
                                        <form method="post" action="">
                                            ...
                                            <div class="wrap-filter">
                                                ...
                                                <a class="filtersbtn" href="admin.php?action=StaffShsStudLibraryUsersGraph"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
