...
<title>SHS TEACHERS LIBRARY USERS</title>
                ...
                <section class="content-header" style="background-color:transparent">
                  <br>
                    ...
                    <ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
                        ...
                        <a href="admin.php?action=StaffShsStudLibraryUsers"><button type="button" class="btn" style="color: #3db166;">Students</button></a> 
                        <a href="admin.php?action=StaffShsTeachLibraryUsers"><button type="button" class="btn" style="background: #3db166; color:white">Teachers</button></a> 
                    </ol>
                    </center>
                </section>
                            ...
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
                                <div class="col-md-3"></div>
                                    ...
                                    <center class="noprint">
                                        <div class="small-box bg" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 25px 0px 0px 0px; width:95%; font-family: Wide Latin; height: 130px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
                                            ...
                                            <a style="color: #fff;" href="admin.php?action=StaffShsTeachLibraryUsers"><button type="button" class="abtnb">TABLE DATA </button></a>
                                            <a style="color: #fff;" href="admin.php?action=StaffShsTeachLibraryUsersGraph"><button type="button" class="abtnr">GRAPHICAL DATA</button></a> 
                                        </div>
                                    </center>
                                    <center>
                                        ...
                                        <form class="form-inline" method="POST" action="">
                                            <center>
												<div class="wrap-filter">
													...
													<a class="filtersbtn" href="admin.php?action=StaffShsTeachLibraryUsers"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover" id="articles">
                                        ...
                                        <tbody>
                                            <?php include 'StaffShsTeachLibraryUsersFilter.php'?>
                                        </tbody>
                                    </table>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
