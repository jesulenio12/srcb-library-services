<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "SELECT fullname, count(*) AS topName
                FROM attendance
                WHERE libraryClass = 'High School Library' && userType = 'Teacher'
                                    ...
                                    <div class="noprint">
                                        <form method="post" action="">
                                            <div class="wrap-filter">
                                                ...
                                                <a class="filtersbtn" href="admin.php?action=StaffShsTeachLibraryUsersGraph"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
