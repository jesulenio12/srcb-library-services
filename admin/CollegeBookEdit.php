...
if (Input::exists()) {
    ...
    try {
        ...
        Redirect::to('admin.php?action=hedBookViewCopies&bookTitle=' . urlencode($_GET['bookTitle']));
    } catch (Exception $e) {
        $error;
    }
}
									...
									?>
											<form id="editUser" action="" method="post">
														...
														<div class="col-md-6">
															<div class="add-input-container"> 
																...
																<datalist id="bookSections">
																	...
																	<?php
																		$bookSec = DB:: getInstance()->query("SELECT DISTINCT bookSection FROM books WHERE libraryClass = 'College Library' ORDER BY id ASC");							
												...
												<div class="row">
													...
													<div class=" col-md-6">
														<a style="color: #fff;" href="admin.php?action=hedBookViewCopies&bookTitle=<?php echo urlencode($_GET['bookTitle']); ?>">
