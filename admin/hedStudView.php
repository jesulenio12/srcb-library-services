...
if (Input::exists()) {
    ...
    if (!empty($library_userID)) {
         Redirect::to('admin.php?action=hedStudView&library_userID=' . urlencode($library_userID));
    } else {
       Redirect::to('admin.php?action=studentsHedList');
    }
}
...
<title>HED STUDENTS USER PROFILE</title>
</head>
                	    ...
                	    <div class="col-xs-12" style="padding: 0px 30px 10px 30px">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <br>
                                    <div class="profile">
                                        <?php include 'hedStudViewFilter.php'?>	
                                    </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div><!-- /.col -->
