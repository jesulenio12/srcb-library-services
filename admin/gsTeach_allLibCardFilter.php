...
if (isset($_POST['search'])) {
    ...
    $query = mysqli_query($conn, "SELECT * FROM `userlogin` WHERE archive = 0 && libraryClass = 'Grade School Library' && departmentType = 'Grade School Department' && userType = 'Teacher' " . ($whereClause ? " AND $whereClause" : "") . " ORDER BY `id` DESC") or die(mysqli_error());
            ...
            <div class="row mt-5">
                <div class="col-md-4" style="margin:10px 10px 10px 10px;" class="column">
                    <div class="card-label-button">
                        ...
                        <form method="post" action="gsTeach_move_library_card.php">
