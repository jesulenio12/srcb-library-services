...
<title>JHS Student's Library Cards</title>
</head>
                        ...
                        <div class="col-xs-12" style="padding: 0px 15px 10px 15px">
                            <div style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding: 0px 30px 10px 30px">
								...
								<center class="noprint">
                                        <div class="small-box bg" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 25px 0px 0px 0px; width:95%; font-family: Wide Latin; height: 130px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
                                            <p style="font-size:35px; transform: scale(1, 2);">
                                                JHS STUDENT LIBRARY CARDS
                                            </p>
                                            <a style="color: #fff;" href="admin.php?action=jhsStud_allLibCard"><button type="button" class="abtnb">BULK PRINTING </button></a>
                                            <a style="color: #fff;" href="admin.php?action=jhsStud_allLibCardSelect"><button type="button" class="abtnr">SELECTIVE PRINTING</button></a> 
                                        </div>
                                    </center>
                            	...
                            	<div class="box-body">
											...
											<center>
												<div class="wrap-filter" class="noprint">
													...
													<div class="filter-input-group"> 
														...
														<input type="time" class="filter-input-box" placeholder="Start"  name="time1" value="<?php echo isset($_POST['time1']) ? $_POST['time1'] : '' ?>" />
													</div>
													<div class="filter-input-group"> 
														<label class="filter-input-label">TO TIME</label>
														<input type="time" class="filter-input-box" placeholder="End"  name="time2" value="<?php echo isset($_POST['time2']) ? $_POST['time2'] : '' ?>" />
													</div> -->
												</div>
												<br>
												<div class="wrap-filter" class="noprint">
                                        		...
                                        		<a style="color: #fff;" href="admin.php?action=jhsStud_allLibCard"><button class="btn2 noprint" type="button"><i class="fa fa-refresh"></i></button></a>
												<button class="btn2 noprint" name="search" onclick="window.print();"><i class="fa fa-print"></i></button>
												<button style="margin-left:3px" type="button" class="btn2-1 noprint" onclick="window.location='admin.php?action=studentsJhsList'">Cancel</button>
											</center>
										</form>
										<br>
									</div>
									...
									<div class="libcard">
										<?php include 'jhsStud_allLibCardFilter.php'?>
									</div>
								<!-- Modal -->
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
