...
<title>HED Department Teachers</title>
</head>
										...
										<div class="progress-table" style="background-color:transparent">
											...
											<div class="clearfix"></div><hr />
												...
												<center>
													<div class="row">
														<div class="col-md-12">
															<a style="color: #fff;" href="admin.php?action=hedTeach_OnlineUserList"><button style="margin-bottom: 25px; margin-top:-25px" type="button" class="btncancel">BACK TO LIST</button></a> 
														</div>
													</div>
												</center>
											</div>
