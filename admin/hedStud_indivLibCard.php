...
<title>HED Student's Library Card</title>
</head>
                            ...
                            <div class="box-body">
                                    <div class="form-actions">
										<div class="row" class="noprint" style="padding:0px 150px 0px 150px">
											...
											<div class="col-md-6">
												<button type="button" class="btncancel noprint" onclick="window.location='admin.php?action=studentsHedList'">Cancel</button>
											</div>
										</div>
										<br>
                                    </div>
													...
													<div class="card-body">
														...
														<p class="card-text" style="margin-top:-17px" align="left">
															...
															<span style="font-family:Arial">
																<?php echo $library_users->yearLevel ; ?> | <?php echo $library_users->progtrack ; ?><br>
																ID No. C<?php echo substr($library_users->library_userID, 3, 255); ?> 
																	<br>
