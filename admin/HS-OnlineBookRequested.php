...
if (Input::exists()) {
		...
		Redirect::to('admin.php?action=HS-OnlineBookRequested');	
...
<title>HS Online Book Requested</title>
</head>
                  ...
                  <br>
                    <center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=HS-OnlineBookRequested"><button type="button" class="btn" style="background: #3db166; color:white">Book Requested</button></a> 
