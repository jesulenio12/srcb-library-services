...
<title>GS Teacher's Library Card</title>
</head>
                            ...
                            <div class="box-body">
                                    <div class="form-actions">
										<div class="row" class="noprint" style="padding:0px 150px 0px 150px">
											...
											<div class="col-md-6">
												<button type="button" class="btncancel noprint" onclick="window.location='admin.php?action=teachersElemList'">Cancel</button>
											</div>
										</div>
										<br>
                                    </div>
										...
										foreach($library_users->results() as $library_users){?>
											<div class="col-md-12" style="margin:10px 0px 10px 0px;" class="column">
												<div class="card" style="background:white; border: 3px solid #163269; border-radius:10px; width:443px;">
													<div class="card-body">
														...
														<p class="card-text" style="margin-top:-17px" align="left">
															...
															<span style="font-family:Arial">
																<?php echo $library_users->userType ; ?><br>
													...
													<img src="admin/teachersQRCodes/<?php echo ($library_users->qrcode) ?>" width="200px" height="170px" style="border-radius:10px; margin-left:10px; margin-right:-10px"  class="card-img-qr">
												</div>
											</div>
									<?php }?>         
								</div>
