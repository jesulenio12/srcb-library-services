...
<title>HED Library Staff Archive List</title>
</head>
                  ...
                  <br>
				  	<center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=AdminArchiveList"><button type="button" class="btn-mb" style="color:#3db166;">Administrator</button></a> 
							<a href="admin.php?action=hed_StaffArchiveList"><button type="button" class="btn-mb" style="background: #3db166; color:white">HED Staff</button></a> 
							<a href="admin.php?action=hs_StaffArchiveList"><button type="button" class="btn-mb" style="color:#3db166;">HS Staff</button></a> 
							<a href="admin.php?action=gs_StaffArchiveList"><button type="button" class="btn-mb" style="color:#3db166;">GS Staff</button></a> 
						</ol>
                    </center>
                </section>
                <!-- Main content -->
                        ...
                        <div class="col-xs-12" style="padding: 0px 15px 10px 15px">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
										...
										<center>
											<div class="small-box bg" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 25px 0px 0px 0px; width:95%; font-family: Wide Latin; height: 115px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
												<p style="font-size:35px; transform: scale(1, 2);">
													HED LIBRARY STAFF ARCHIVE LIST
												</p>
											</div>
										</center>
										<br>
										...
										<form class="form-inline" method="POST" action="">
											<center>
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=hed_StaffArchiveList"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
                                ...
                                <div class="box-body table-responsive">
									...
									<?php }?>
									<form action="hed_StaffArchive_chkboxcode.php" method="POST">
										<table class="table table-bordered table-hover" id="articles">
																...
																<div class="modal-dialog modal-lg" role="document">
																	<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
																		...
																		<div class="modal-body">
																			<center>
																				<p  style="font-size:30px"> Are you sure you want to activate staff(s)? </p>
																			</center>
											...
											<tbody>
												<?php include 'hed_StaffArchiveListFilter.php'?>
											</tbody>
										</table>
									</form>
                                </div><!-- /.box-body -->
