									...
									?>
											<form id="editUser" action="" method="post">
														...
														<div class="col-md-6">
															<div class="add-input-container"> 
																...
																<datalist id="bookSections">
																	...
																	<?php
																		$bookSec = DB:: getInstance()->query("SELECT DISTINCT bookSection FROM books WHERE libraryClass = 'High School Library' ORDER BY id ASC");							
												...
												<div class="row">
													...
													<div class=" col-md-6">
														<a style="color: #fff;" href="admin.php?action=hsBookViewCopies&bookTitle=<?php echo urlencode($_GET['bookTitle']); ?>">
