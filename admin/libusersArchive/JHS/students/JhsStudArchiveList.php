...
<title>JHS Students Archive List</title>
</head>
				...
				<section class="content-header" style="background-color:transparent">
                  <br>
                    ...
                    <ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
                        ...
                        <a href="admin.php?action=HedStudArchiveList"><button type="button" class="btn-mb" style="color:#3db166">HED Students</button></a> 
                        <a href="admin.php?action=ShsStudArchiveList"><button type="button" class="btn-mb" style="color:#3db166">SHS Students</button></a> 
						<a href="admin.php?action=JhsStudArchiveList"><button type="button" class="btn-mb" style="background: #3db166; color:white">JHS Students</button></a> 
                        <a href="admin.php?action=ElemStudArchiveList"><button type="button" class="btn-mb" style="color:#3db166">GS Students</button></a> 
                    </ol>
                    </center>
                </section>
                <!-- Main content -->
                        ...
                        <div class="col-xs-12" style="padding: 0px 15px 10px 15px">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
										...
										<div class="conpost">
											<div class="container">
												<div class="data">
													<div class="content">
													<?php 
													$userlogin = DB:: getInstance()->query("SELECT * FROM userlogin WHERE departmentType='Junior High School Department' && yearLevel != 'Graduated' && userType='Student' AND archive = 1");
												...
												<div class="data">
													<div class="content">
														<?php 
														$library_usersGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Male' AND departmentType='Junior High School Department' && yearLevel != 'Graduated' AND userType='Student' AND archive = 1");
												...
												<div class="data">
													<div class="content">
													<?php 
													$library_usersGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Female' AND departmentType='Junior High School Department' && yearLevel != 'Graduated' AND userType='Student' AND archive = 1");
													$countLibrary_usersG =DB:: getInstance()->count($library_usersGender);?>
														<div class="inner">
															<h3>
																<?php echo $countLibrary_usersG; ?>
								...
								<div class="noprint">
										<form class="form-inline" method="POST" action="">
											...
											<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=JhsStudArchiveList"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
                                ...
                                <div class="box-body table-responsive">
									...
									<?php }?>
									<form action="archive_jhs_chkboxcode.php" method="POST">
										<table class="table table-bordered table-hover" id="articles">
																...
																<div class="modal-dialog modal-lg" role="document">
																	<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
																		...
																		<div class="modal-body">
																			<center>
																				<p  style="font-size:30px"> Are you sure you want to activate student(s)? </p>
																			</center>
											...
											<tbody>
												<?php include 'admin/libusersArchive/JHS/students/jhs_studlibusersArchive.php'?>
											</tbody>
										</table>
									</form>
                                </div><!-- /.box-body -->
