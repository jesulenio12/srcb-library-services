...
<title>HED Teachers Archive List</title>
</head>
				...
				<section class="content-header" style="background-color:transparent">
                  <br>
                    ...
                    <ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
                        ...
                        <a href="admin.php?action=HedTeachArchiveList"><button type="button" class="btn-mb" style="background: #3db166; color:white">HED Students</button></a> 
                        ...
                        <div class="col-xs-12" style="padding: 0px 15px 10px 15px">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
										...
										<div class="conpost">
											<div class="container">
												<div class="data">
													<div class="content">
													<?php 
													$userlogin = DB:: getInstance()->query("SELECT * FROM userlogin WHERE departmentType='Higher Education Department' && userType='Teacher' AND archive = 1");
												...
												<div class="data">
													<div class="content">
														<?php 
														$library_usersGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Male' AND departmentType='Higher Education Department' AND userType='Teacher' AND archive = 1");
												...
												<div class="data">
													<div class="content">
													<?php 
													$library_usersGender = DB:: getInstance()->query("SELECT * FROM userlogin WHERE gender='Female' AND departmentType='Higher Education Department' AND userType='Teacher' AND archive = 1");
													$countLibrary_usersG =DB:: getInstance()->count($library_usersGender);?>
														<div class="inner">
															<h3>
																<?php echo $countLibrary_usersG; ?>
										...
										<form class="form-inline" method="POST" action="">
											<center>
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=HedTeachArchiveList"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
                                ...
                                <div class="box-body table-responsive">
									...
									<?php }?>
									<form action="archive_hedTeach_chkboxcode.php" method="POST">
										<table class="table table-bordered table-hover" id="articles">
											...
											<tbody>
												<?php include 'admin/libusersArchive/HED/teachers/hed_teachlibusersArchive.php'?>
											</tbody>
										</table>
									</form>
                                </div><!-- /.box-body -->
