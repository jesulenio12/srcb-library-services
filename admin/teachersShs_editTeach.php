...
if (Input::exists()) {
			...
			Redirect::to('admin.php?action=teachersShsList');
            } catch(Exception $e) {
                $error;
            }
}
								...
								<form id="editUser" action="" method="post">
									...
									<div class="clearfix"></div><hr />
										<div class="row">
											...
											<div class=" col-md-6">
												<a style="color: #fff;" href="admin.php?action=teachersShsList"><button type="button" class="btncancel">CANCEL</button></a> 
											</div>
										</div>
									<br />
                                </form>
