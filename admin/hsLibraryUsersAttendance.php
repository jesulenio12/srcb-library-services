    ...
    if(Token::check(Input::get('token'))) {  
            ...
            try {
				if($prev_id_entry != $qrcod){
					...
					Redirect::to('admin.php?action=hsLibraryUsersAttendance');
				}
												...
												<div class="row">
													...
													<div class="col-xs-12">
														...
														<div style="display:none"id="qrinvalid" name="qrinvalid" class="alert alert-danger" >
															...
															<audio src="admin/beep.mp3" id="audio" preload="auto" style="display:none"></audio>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="table-row">
														<div class="box box-primary" id="loading-example" style="border-radius: 10px">
															...
															<div class="box-body table-responsive">
																...
																<tbody>
																	<?php include 'hsLibraryUsersAttendanceSorting.php'?>	
																</tbody>
															</table>
														</div>
