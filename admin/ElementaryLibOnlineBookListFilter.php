...
if (isset($_POST['filterbook'])) {
    ...
    $borrowedBooksQuery = mysqli_query($conn, "SELECT DISTINCT bookAccession FROM books WHERE status = 'Not Available' AND libraryClass = 'Grade School Library'") or die(mysqli_error());
    $borrowedBooks = array();
    ...
    $query = mysqli_query($conn, "SELECT b.*, i.bookImage, COUNT(*) as availableCopies
        ...
        WHERE b.bookSection != 'General References' AND b.bookSection != 'Dictionaries' AND libraryClass = 'Grade School Library'
            ...
            <div class="row mt-5">
                <div class="col-md-4" class="column">
                    <div class="card">
						...
						<form method="POST" action="gs_request_book_online.php" style="display:inline">
