...
if (isset($_POST['filterbook'])) {
    ...
    $query = mysqli_query($conn, "SELECT b.*, COUNT(*) as totalCopies,
        ...
        FROM books b 
        WHERE b.bookSection != 'Periodical' AND b.lost = 0 AND discarded = 0 AND libraryClass = 'Grade School Library'
    ...
    if ($row > 0) {
        ...
        <tr>
            ...
            <td>
                <form method="POST" action="admin.php?action=gsBookViewCopies&&bookTitle=<?php echo urlencode($fetch['bookTitle']); ?>" style="display:inline">
