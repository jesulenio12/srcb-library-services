...
<link rel="stylesheet" type="text/css" href="css/hs-staff-bookloaning.css">
								...
								<form class="form-inline" method="POST" action="">
									<center>
										...
										<div class="dropdown-filter">
											...
											<a style="color: #fff;" href="admin.php?action=hsStaff_BookLoaning"> <button class="btn2" type="button"><i class="fa fa-refresh"></i>Reset</button></a>
										</div>
									</center>
								</form>
							</div>
