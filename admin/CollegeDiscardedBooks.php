...
if (Input::exists()) {
		$PNG_TEMP_DIR =  dirname(__FILE__).DIRECTORY_SEPARATOR.'bookQRCodes'.DIRECTORY_SEPARATOR;
			...
			Redirect::to('admin.php?action=CollegeDiscardedBooks');	
		}
}
?>
<!DOCTYPE html>
...
<title>HED Library Discarded Book List</title>
</head>
				...
				<section class="content-header" style="background-color:transparent">
                    ...
                    <center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=CollegeBookList"><button type="button" class="btn-mb" style="color:#3db166;">Book List</button></a> 
							<a href="admin.php?action=CollegePeriodicalList"><button type="button" class="btn-mb" style="color:#3db166;">Periodical Books</button></a> 
							<a href="admin.php?action=CollegeDiscardedBooks"><button type="button" class="btn-mb" style="background: #3db166; color:white">Discarded Books</button></a> 
							<a href="admin.php?action=CollegeLostBooks"><button type="button" class="btn-mb" style="color:#3db166;">Lost Books</button></a> 
						</ol>
                    </center>
                </section>
                <!-- Main content -->
                            ...
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
										...
										<form class="form-inline" method="POST" action="" style="margin-left: 20px">
											<center>
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=CollegeDiscardedBooks"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
                                ...
                                <div class="box-body table-responsive">
									...
									<table class="table table-bordered table-hover" id="articles">
										...
										<tbody>
												<?php include 'CollegeDiscardBookFilterSec.php'?>	
										</tbody>
                                    </table>
                                </div><!-- /.box-body -->
								...
								<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog modal-lg" role="document" style="width:50%">
										...
										<div class="modal-body">
											<form enctype="multipart/form-data" method="post" action="CollegeDiscardedAddBook.php">
											<div class="row">
												<div class="col-md-6">
											...
											<div class="row">
												<div class="col-md-12">
													...
													<div class="form-group" style="width:100%">
														<textarea style="padding-top:65px; font-size: 15px; border: 2px solid #163269; border-radius:6px" cols="30" rows="5" type="text" class="form-control" id="bookDescription" name="bookDescription" placeholder="Input Book Description..."></textarea>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="add-input-container"> 
														...
														<input type="text" class="add-input" id="subject" name="subject" required>
													</div>
												</div>
												<div class="col-md-6">
													<div class="add-input-container"> 
											...
											<div class="row">
												<div class="col-md-6">
													<div class="add-input-container"> 
														...
														<input type="text" class="add-input" id="etAl_authors" name="etAl_authors" required>
													</div>
												</div>
												<div class="col-md-6">
													<div class="add-input-container"> 
											...
											<div class="row">
												<div class="col-md-6">
													<div class="add-input-container"> 
														...
														<input type="text" class="add-input" id="glossary" name="glossary" required>
													</div>
												</div>
												<div class="col-md-6">
													<div class="add-input-container"> 
														<span for="bibliography">Bibliography Page</span>
														<input type="text" class="add-input" id="bibliography" name="bibliography" required>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="add-input-container"> 
														...
														<input type="text" class="add-input" id="appendix" name="appendix" required>
													</div>
												</div>
												<div class="col-md-6">
													<div class="add-input-container"> 
														<span for="indexNumber">Index Page</span>
														<input type="text" class="add-input" id="indexNumber" name="indexNumber" required>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="add-input-container"> 
														...
														<input type="text" class="add-input" id="includes" name="includes" required>
													</div>
												</div>
												<div class="col-md-6">
													<div class="add-input-container"> 
														<span for="publisher">Publisher</span>
														<input type="text" class="add-input" id="publisher" name="publisher" required>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="add-input-container"> 
														...
														<input type="text" class="add-input" list="bookSections" name="bookSection" id="bookSection" required>
											...
											<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
												...
												<div class="modal-body" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
													<p class="form-paragraph">
														File should be a .csv format or download this file template <a style="color:#fff" href="CSVDiscardedBookTemplate.php"> <button class="btncsv" type="submit"> CSV Template <i class="fas fa-file-download"></i></button></a>
													</p>
													<form enctype="multipart/form-data" method="post" action="CollegeDiscardedBulkUpload.php">
