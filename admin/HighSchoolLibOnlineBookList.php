				...
				<section class="content-header" style="background-color:transparent">
                    ...
                    <center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=HighSchoolLibOnlineBookList"><button type="button" class="btn-mb" style="color:white; background-color: #3db166">HS LIBRARY</button></a> 
                        ...
                        <div class="col-md-15">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding: 10px 0px 10px 45px">
											...
											<div class="wrap-filter" class="noprint">
												...
												<div class="filter-input-group"> 
													...
													<select class="filter-input-box" for="author" name="author" id="author">
														...
														<?php
															$books = DB:: getInstance()->query("SELECT DISTINCT author FROM books WHERE libraryClass = 'High School Library' ORDER BY id ASC");							
												...
												<a class="filtersbtn" href="admin.php?action=HighSchoolLibOnlineBookList"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
											</div>
										</center>
									</form>
									<div class="table-responsive">
										...
										<?php }?> 
										<div class="bookqr">
											<?php include 'HighSchoolLibOnlineBookListFilter.php'?>
										</div>
									</div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div><!-- /.col -->
...
<script>
    ...
    $('#moreInfo').on('show.bs.modal', function (event) {
        ...
        if (image) {
            modal.find('#bookImage').attr('src', 'admin/hsBookImages/' + image);
        } else {
