...
<title>JHS Teachers Daily Users Log</title>
</head>
                ...
                <section class="content-header" style="background-color:transparent">
					...
					<center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=teacherJhsAttendance"><button type="button" class="btn-mb" style="background: #3db166; color:white">JHS Teachers</button></a> 
								...
								<div class="col-md-3"></div>
										...
										<form class="form-inline" method="POST" action="">
											<center>
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=teacherJhsAttendance"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
									...
									<div class="table-responsive">	
										<table class="table table-bordered table-hover" id="articles">
											...
											<tbody>
												<?php include 'admin/attendanceLogs/dailyusersDF/teachers/jhs_dailyusersteachDF.php'?>	
											</tbody>
										</table>
									</div class="noprint">	
                            </div><!-- /.box -->
