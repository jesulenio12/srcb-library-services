...
<title>GS Teachers Daily Users Log</title>
</head>
                ...
                <section class="content-header" style="background-color:transparent">
					...
					<center>
						<ol class="breadcrumb" style="background-color: rgba(255, 255, 255, 0.239); border-radius:30px; margin-top:-5px;">
							...
							<a href="admin.php?action=teacherHedAttendance"><button type="button" class="btn-mb" style="color:#3db166;">HED Teachers</button></a> 
							<a href="admin.php?action=teacherShsAttendance"><button type="button" class="btn-mb" style="color:#3db166;">SHS Teachers</button></a> 
							<a href="admin.php?action=teacherJhsAttendance"><button type="button" class="btn-mb" style="color:#3db166;">JHS Teachers</button></a> 
							<a href="admin.php?action=teacherElemAttendance"><button type="button" class="btn-mb" style="background: #3db166; color:white">GS Teachers</button></a> 
						</ol>
                    </center>
                </section>
								...
								<div class="col-md-3"></div>
									...
									<br>
										<center>
											<div class="small-box bg noprint" style="background-image: url(images/background.jpg); background-size:cover; background-position:center center; background-repeat: no-repeat; color:white; padding: 25px 0px 0px 0px; width:95%; font-family: Wide Latin; height: 115px; box-shadow: 0px 4px 10px 1px rgba(0, 0, 0, 0.418); border-radius: 100px; border: 7px solid lightgrey;">
												<p class="noprint" style="font-size:35px; transform: scale(1, 2);">
													GS TEACHERS DAILY USERS LOG
												</p>
											</div>
										</center>
									<br>
										...
										<form class="form-inline" method="POST" action="">
											<center>
												<div class="wrap-filter" class="noprint">
													...
													<a class="filtersbtn" href="admin.php?action=teacherElemAttendance"><button style="background:transparent; border:none; padding-top: 7px; color:#fff" type="button"><i class="fa fa-refresh"></i></button></a>
									...
									<div class="table-responsive">	
										<table class="table table-bordered table-hover" id="articles">
											...
											<tbody>
												<?php include 'admin/attendanceLogs/dailyusersDF/teachers/grdschl_dailyusersteachDF.php'?>	
											</tbody>
										</table>
									</div class="noprint">	
                            </div><!-- /.box -->
