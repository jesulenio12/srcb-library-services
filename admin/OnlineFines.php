                        ...
                        <div class="col-md-15">
                            <div class="box box-primary" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding:10px">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <tbody>
											<?php
												$books = DB:: getInstance()->query("SELECT * FROM booktransactions WHERE transactionType = 'return' && remarks = 'Overdue' order by id DESC ");		
												foreach($books->results() as $books){ 
													...
													<tr>
                                                        ...
                                                        <td data-label="Pickup Date"><?php echo $books->pickupDate ; ?></td>
                                                        <td data-label="Due Date"><?php echo $books->dueDate ; ?></td>
                                                        <td data-label="Date Returned"><?php echo $books->transactionDate ; ?></td>
                                                        <td data-label="Day(s) Lapses"><?php echo $books->interval2 ; ?></td>
                                                        <td data-label="FPDD">₱<?php echo $books->finesperDueDate ; ?>.00</td>
                                                        <td data-label="Fines">₱<?php echo $books->totalFines ; ?>.00</td>
                                                        <td align="center" data-label="Remarks">
                                                            <?php if($books->payment == '0'){?>
