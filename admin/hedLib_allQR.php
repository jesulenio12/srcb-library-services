...
<title>HED Library QR Codes</title>
</head>
                            ...
                            <div style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat; border-radius: 30px; padding: 0px 30px 10px 30px">
								...
								<center class="noprint">
									<div class="small-box bg">
										<p> HED BOOK QR CODES  </p>
									</div>
									<div class="under-label-btn">
										<a style="color: #fff;" href="admin.php?action=hedLib_allQR"><button type="button" style="background: #3db166; color:white" class="abtnb">BULK PRINTING </button></a>
										<a style="color: #fff;" href="admin.php?action=hedLib_allQRSelect"><button type="button" style="background: #fff; color: #3db166;" class="abtnr">SELECTIVE PRINTING</button></a> 
									</div>
								</center>
                            	<div class="box-body">
									<br>
									<form class="form-inline" method="POST" action="" style="margin-left: 20px">
										<center class="noprint" >
											...
											<br>
											<button class="filtersbtn noprint" name="filterbook"><i class="fa fa-filter"></i></button>
											<a style="color: #fff;" class="noprint"  href="admin.php?action=hedLib_allQR"><button class="filtersbtn noprint" type="button"><i class="fa fa-refresh"></i></button></a>
											<button class="filtersbtn noprint" name="search" onclick="window.print();"><i class="fa fa-print"></i></button>
											<button style="margin-left:3px" type="button" class="btn-label noprint" onclick="window.location='admin.php?action=CollegeBookList'">Cancel</button>
										</center>
									</form>
									...
									<div class="bookqr">
										<?php include 'hedLib_allQRFilter.php'?>
									</div>
								<!-- Modal -->
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
