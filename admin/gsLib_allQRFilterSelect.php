...
require 'conn.php';
    ...
    $query = mysqli_query($conn, "SELECT * FROM `indivqrbook` WHERE libraryClass = 'Grade School Library' ORDER BY `id` DESC") or die(mysqli_error());
				...
				<div class="card">
					<div class="card-body">
                        <div class="card-label-button">
                            <form method="post" action="gs_return_library_book.php">
