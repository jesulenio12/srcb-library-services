...
if (isset($_POST['filterbook'])) {
    ...
    $borrowedBooksQuery = mysqli_query($conn, "SELECT DISTINCT bookAccession FROM books WHERE status = 'Not Available' AND libraryClass = 'College Library'") or die(mysqli_error());
    $borrowedBooks = array();
    ...
    $query = mysqli_query($conn, "SELECT b.*, i.bookImage, COUNT(*) as availableCopies
        ...
        WHERE b.bookSection != 'General References' AND b.bookSection != 'Dictionaries' AND libraryClass = 'College Library'
					...
					<div class="book-image-card">
						<div class="card-body">
							<?php if (!empty($fetch['bookImage'])) { ?>
								<img src="admin/hedBookImages/<?php echo $fetch['bookImage']; ?>" width="100%" height="350px" class="card-img-qr">
							<?php } else { ?>
								<img src="admin/images/default.png" width="100%" height="350px" class="card-img-qr">
							<?php } ?>
							<br>
							<div class="card-text">
						...
						<form method="POST" action="hed_request_book_online.php" style="display:inline">
				...
				<div class="modal fade" id="moreInfo" tabindex="-1" role="dialog" aria-labelledby="moreInfoLabel" aria-hidden="true">
					<div class="modal-dialog modal-sm">
						<div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
							<div class="modal-body" >
								<center>
									<img id="bookImage" width="100%" height="350px" class="card-img-qr">
									<br>
