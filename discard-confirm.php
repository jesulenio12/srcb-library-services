<!-- Modal Dialog -->
  <div class="modal fade" id="confirmDiscard" role="dialog" aria-labelledby="confirmDiscardLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
        ...
        <div class="modal-body" >
          <p  style="font-size:30px"> Are you sure you want to discard this? </p>
        </div>
        <div class="modal-footer">
          <div class="row">
            <div class=" col-md-6">
              <button type="button" class="btnupdate" id="confirm">Discard</button>
            </div>
            <div class=" col-md-6">
