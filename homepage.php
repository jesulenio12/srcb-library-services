...
<head>
    ...
    <title>QRBASEDLMS - Home Page</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">SRCB</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="admin-staff-index.php">Admin | Staff</a></li>
                        <li><a href="col-lib-index.php">College Library</a></li>
                        <li><a href="hs-lib-index.php">High School Library</a></li>
                        <li><a href="elem-lib-index.php">Elementary</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <div class="banner" style="background-image: url(images/bg1.jpg);"></div>
                ...
                <div class="item">
                    <div class="banner" style="background-image: url(images/bg2.jpg);"></div>
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <div class="banner" style="background-image: url(images/bg3.jpg);"></div>
                    <div class="carousel-caption">
