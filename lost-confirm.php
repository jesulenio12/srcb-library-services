<!-- Modal Dialog -->
<div class="modal fade" id="confirmLost" role="dialog" aria-labelledby="confirmLostLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" style="background-image: url(images/nav2.jfif); background-size:cover; background-position:center center; background-repeat: no-repeat;">
      ...
      <div class="modal-body" >
        <p  style="font-size:30px"> Are you sure this was book lost? </p>
      </div>
